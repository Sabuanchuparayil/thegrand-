      ...
      <div className="space-y-6">
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="/"
                target="_blank"
                className="flex items-center space-x-2 text-charcoal/70 hover:text-gold transition-colors"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input
                type="color"
                defaultValue="#B8860B"
                className="w-full h-12 rounded-lg border border-charcoal/20"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-charcoal mb-2">
        ...
        <div className="bg-white rounded-lg luxury-shadow p-6">
          ...
          <div className="p-4 bg-cream rounded-lg">
            <h3 className="font-semibold text-charcoal mb-2">Current Banners:</h3>
