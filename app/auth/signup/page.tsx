          ...
          <div className="bg-white rounded-lg p-8 luxury-shadow">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-charcoal/30" />
                  <input
                    type="text"
                    value={formData.name}
              ...
              <div>
                ...
                <div className="relative">
                  <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-charcoal/30" />
                  <input
                    type="tel"
              ...
              <div>
                ...
                <p className="text-xs text-charcoal/50 mt-1">
                  Include country code for marketing communications
                </p>
              </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-charcoal/70">Or sign up with</span>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-charcoal/70">
                ...
                <Link href="/auth/signin" className="text-gold hover:text-gold/80 font-semibold">
                  Sign In
                </Link>
              </p>
            </div>
